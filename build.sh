...
# MVPKG.INC/PLATFORM.H — the per-platform facts the sources $INCLUDE.  Written
...
* PLATFORM.H - platform compile-time defines.  Generated by build.sh.
* MVX is a builtin compiler define; these are the facts it does not carry.
